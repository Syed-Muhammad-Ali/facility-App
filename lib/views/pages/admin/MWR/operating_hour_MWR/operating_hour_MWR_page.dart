...
import 'package:facility_managing/views/pages/admin/MWR/operating_hour_MWR/components/oper_hour_MWR.dart';
...
class OperatingHourMWRPage extends StatefulWidget {
  const OperatingHourMWRPage({super.key});

  @override
  State<OperatingHourMWRPage> createState() => _OperatingHourMWRPageState();
}

class _OperatingHourMWRPageState extends State<OperatingHourMWRPage> {
