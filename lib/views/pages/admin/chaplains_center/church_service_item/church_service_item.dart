...
import 'package:facility_managing/views/pages/admin/chaplains_center/church_service_item/components/churchServiceContainer.dart';
...
class ChurchServiceItem extends StatefulWidget {
  const ChurchServiceItem({super.key});

  @override
  State<ChurchServiceItem> createState() => _ChurchServiceItemState();
}

class _ChurchServiceItemState extends State<ChurchServiceItem> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomBackAppBar(title: "Operating Hours MWR"),
      body: Column(
        children: [
          2.hSpace(context),
          ListView.builder(
